...
class LiquidGlass {
  ...
  static const double opacityHeavy = 0.28;

  // Tint colors for glass
  static Color glassTint(bool isDark) =>
      isDark ? Colors.white : Colors.white;
  static double glassTintOpacity(bool isDark) => isDark ? 0.08 : 0.55;
  ...
  static BoxDecoration glassDecoration({
    ...
    return BoxDecoration(
      color: (tint ?? (isDark ? Colors.white : Colors.white))
          .withOpacity(isDark ? 0.08 : 0.45),
...
void main() async {
  ...
  // Pedir permisos de notificación en iOS
          ...
          builder: (lightDynamic, darkDynamic) {
            ...
            return MaterialApp(
              ...
              theme: ThemeData(
                ...
                // iOS 26 Liquid Glass: fondo puro negro/blanco
                ...
                textTheme: GoogleFonts.interTextTheme(
                  ...
                  // SF Pro-like con Inter - típico iOS 26
                ...
                splashFactory: NoSplash.splashFactory, // iOS no tiene ripple
                ...
                appBarTheme: AppBarTheme(
                  centerTitle: true, // iOS centra los títulos
                ...
                floatingActionButtonTheme: FloatingActionButtonThemeData(
                  ...
                  backgroundColor: isDark
                      ...
                      : Colors.white.withOpacity(0.8),
                  foregroundColor: activeScheme.primary,
                ),
              ),
              home: initialScreen,
...
// ============================================================
// LIQUID GLASS WIDGET - iOS 26 authentic
// ============================================================
    ...
    child: BackdropFilter(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          // Liquid Glass: capa blanca translúcida vibrante
          color: Colors.white.withOpacity(0.12),
          border: Border(
            top: BorderSide(color: Colors.white.withOpacity(0.45), width: 0.5),
            left: BorderSide(color: Colors.white.withOpacity(0.35), width: 0.5),
...
Widget _buildAuraBackground(BuildContext context, Widget child) {
  ...
  // iOS 26 Liquid Glass: fondo con orbes de color difuminados
  return Stack(
    children: [
      RepaintBoundary(
        child: Stack(
          children: [
            // Base: blanco puro en light, negro profundo en dark
            Container(
              color: isDark ? const Color(0xFF000000) : const Color(0xFFF2F2F7),
            ),
            // Orbe primario - arriba izquierda
            Positioned(
              top: -100,
              left: -80,
              child: Container(
            ...
            // Orbe secundario - centro derecha
            Positioned(
              top: 200,
              right: -120,
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      secondary.withOpacity(isDark ? 0.28 : 0.16),
                      Colors.transparent,
                    ],
                  ),
                ),
            ...
            // Orbe terciario - abajo izquierda
            Positioned(
              bottom: -80,
              left: -60,
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      tertiary.withOpacity(isDark ? 0.22 : 0.14),
                      Colors.transparent,
                    ],
                  ),
                ),
            ...
            // Capa de ruido sutil (simulada con gradiente)
            Positioned.fill(
              child: DecoratedBox(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Colors.white.withOpacity(isDark ? 0.02 : 0.0),
                      Colors.transparent,
                      Colors.black.withOpacity(isDark ? 0.05 : 0.0),
                    ],
                  ),
                ),
              ),
...
void _showRedPopup(BuildContext context, String message) {
  ...
  showDialog(
    ...
    builder: (c) => BackdropFilter(
      ...
      child: AlertDialog(
        backgroundColor: Theme.of(context).colorScheme.errorContainer.withOpacity(0.85),
        title: Row(
        children: [
          Icon(
            ...
            Row(
              children: [
                ClipRRect(
                  ...
                  decoration: BoxDecoration(
                    color: Theme.of(context).colorScheme.primary.withOpacity(isDark ? 0.25 : 0.12),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate((context, i) {
                    ...
                    final _isDarkCard = Theme.of(context).brightness == Brightness.dark;
                    return ClipRRect(
                          borderRadius: BorderRadius.circular(UIConstants.cardRadius),
                          child: BackdropFilter(
                            ...
                            child: Card(
                          color: unread > 0
                              ? Theme.of(context).colorScheme.primary.withOpacity(_isDarkCard ? 0.18 : 0.10)
                              : (_isDarkCard
                                  ? Colors.white.withOpacity(0.07)
...
class MDBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Mis mensajes: tinte de color con vidrio
    // Mensajes del peer: vidrio neutro
    return ClipRRect(
